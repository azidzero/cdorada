...
$q = mysqli_query($CNN, "INSERT INTO crm_incidence_gallery(iid) VALUES('$id')");
...
$file = $im_pre . "_" . $oid;
mysqli_query($CNN, "UPDATE crm_incidence_gallery SET namei='$file', created=CURRENT_TIMESTAMP WHERE id=$nid");
