...
switch ($o) {
                    ...
                    <table class="table table-condensed" style="font-size: 9pt;" >                   
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-user-plus"></i>Tipo contacto:</span>
    ...
    case 1:
        ...
        mysqli_query($CNN, "INSERT INTO crm_company(name, contacttype, telephone, email, website, typeweb, address, city, state, zipcode, country, description, currency) VALUES('$name','$tipoC','$telephone','$email','$webSite','$tipoW','$address','$city','$state','$zipCode','$country','$description', '$currency')");
