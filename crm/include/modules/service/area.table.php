...
while ($aRow = mysqli_fetch_array($rResult)) {
    ...
    <a href="./?m=service&s=area&o=3&id=' . $aRow[0] . '" class="btn btn-primary" title="Editar"><i class="fa fa-edit"></i></a>
    <a href="./?m=service&s=area&o=5&id=' . $aRow[0] . '" class="btn btn-danger" title="Eliminar"><i class="fa fa-trash-o"></i></button>';
    $row[2].='</div>';
    $output['aaData'][] = $row;
}
