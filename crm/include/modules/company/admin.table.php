...
while ($aRow = mysqli_fetch_array($rResult)) {
    ...
    $row[4] .= "<li><a href=\"./?m=company&s=admin&o=1&id={$aRow[0]}\"><i class=\"fa fa-edit\"></i> Editar</a></li>";
    $row[4] .= "<li><a href=\"./?m=company&s=admin&o=2&id={$aRow[0]}\"><i class=\"fa fa-trash\"></i> Eliminar</a></li>";
    $row[4] .= "</ul>";
    $row[4] .= "</div>";
    $output['aaData'][] = $row;
}
