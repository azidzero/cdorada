...
switch ($o) {
    case 0:
        ?>
        <form id="frmService" action="./?m=contacts&s=plus=1" method="post" >
            <div class="row-fluid">
                <div class="col-sm-8">
       ...
       // mysqli_query($CNN, "INSERT INTO crm_contact(name, contacttype, company, companyposition, telephone, email, website, typeweb, address, city, state, zipcode, country, description) VALUES('$name','$tipoC','$company','$companyPosition','$telephone','$email','$webSite','$tipoW','$address','$city','$state','$zipCode','$country','$description')");
        ...
        if (!isset($e)) {
                ...
                <div class="alert alert-success">
                    ...
                    <form action="./?m==contacts&s=plus=2" class="form" method="post" enctype="multipart/form-data" >
        ...
        case 10:
            ...
            <form action="./?m=contacts&s=plus=11" class="form" method="post" enctype="multipart/form-data" >
