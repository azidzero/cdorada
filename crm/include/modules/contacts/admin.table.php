...
while ($aRow = mysqli_fetch_array($rResult)) {
    ...
    $row[5] .= "<li><a href=\"./?m=contacts&s=admin&o=1&id={$aRow[0]}\"><i class=\"fa fa-edit\"></i> Editar</a></li>";
    $row[5] .= "<li><a href=\"./?m=contacts&s=admin&o=2&id={$aRow[0]}\"><i class=\"fa fa-trash\"></i> Eliminar</a></li>";
    $row[5] .= "</ul>";
    $row[5] .= "</div>";
    $output['aaData'][] = $row;
}
