<div id="sidebar">
    <div class="container-fluid">
        <div id="sidebar-header" class="sidebar-module" style="background:rgba(0,24,72,0.95)">
            ...
            <div style="padding:8px;">
                <div class="btn-group btn-group-sm pull-righ btn-group-justified">
                    ...
                    <a href="/crs" class="btn btn-danger">CRS</a></li>
        ...
        <div id="sidebar-user" class="sidebar-module">
            <div class="row">
                <div class="col-sm-4">
                    <img width="52" src="content/account/<?php echo $_SESSION["CMS"]["u5"]; ?>.png" class="img-circle" style="margin:4px auto;" />
                </div>
                <div class="col-sm-8">                        
                    <?php echo $_SESSION["CMS"]["uname"]; ?><br/> 
                    <small>{puesto}</small>                        
                </div>
            </div>
        </div><!-- user area -->
