...
while ($aRow = mysqli_fetch_array($rResult)) {
    ...
    $row[4] .= "<li><a href=\"./?m=crm&s=corp&o=3&id={$aRow[0]}\"><i class=\"fa fa-edit\"></i> Editar</a></li>";
    $row[4] .= "<li><a href=\"./?m=crm&s=corp&o=5&id={$aRow[0]}\"><i class=\"fa fa-trash\"></i> Eliminar</a></li>";
    $row[4] .= "</ul>";
    $row[4] .= "</div>";
    $output['aaData'][] = $row;
}
