...
while ($aRow = mysqli_fetch_array($rResult)) {
    ...
    $row[2] .= "<li><a href=\"JavaScript:void(0)\" onclick=\"jsonloc('{$aRow[0]}','6')\"><i class=\"fa fa-edit\"></i>Editar</a></li>";
    $row[2] .= "<li><a href=\"JavaScript:void(0)\" onclick=\"jsonloce('{$aRow[0]}','6')\"><i class=\"fa fa-trash\"></i> Eliminar</a></li>";
    $row[2] .= "</ul>";
    $row[2] .= "</div>";
    $output['aaData'][] = $row;
}
