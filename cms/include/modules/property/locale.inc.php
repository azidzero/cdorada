                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id='e_destino' name='e_destino' method='POST'>
                            <input type="text" name="op" id="op" value="51" style="visibility:hidden; width: 1px;height: 1px;"/>
                            <input type="text" name="desid" id="desid" style="visibility:hidden; width: 1px;height: 1px;"/>
                            <div class="form-caracteristicas">
                                <label for="recipient-name" class="control-label">Editar destino:</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id='eliminadestino' name='eliminadestino' method='POST'>
                            <input type="text" name="op" id="op" value="52" style="visibility:hidden; width: 1px;height: 1px;"/>
                            <input type="text" name="e_desid" id="e_desid" style="visibility:hidden; width: 1px;height: 1px;"/>
                            <div class="form-caracteristicas">
                                <label for="recipient-name" class="control-label">Eliminar el destino:</label>
...
switch ($o) {
    case 0:
        ?>
        <form id='destino' name='destino' method='POST'>
            <input type="text" name="op" id="op" value="50" style="visibility:hidden; width: 1px;height: 1px;"/>
            <div class="form-caracteristicas">
                <label for="recipient-name" class="control-label"><h2><i class="fa fa-plus-circle"></i> Nuevo Destino:</h2></label>
                <input type="text" name="des_name" class="form-actions" style="width: 50%"id="dest_name"/>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="guradalocali();">Guardar</button> 
            </div>
        </form>
        <?php
        break;
    case 2:
        ...
        <script>
            $(document).ready(function () {
                jTable('tbl_admin', 'include/modules/property/locale2.table.php');
            });
        </script>
        <?php
        break;
