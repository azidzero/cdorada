...
while ($aRow = mysqli_fetch_array($rResult)) 
{
    ...
    $row[0] = $aRow['id'];
    $row[1] = $aRow['name'];
   $row[2] = "<div class=\"btn-group\">";
    $row[2] .= "<button type=\"button\" class=\"btn btn-success dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\">Opciones <span class=\"caret\"></span></button >";
    $row[2] .= "<ul class=\"dropdown-menu dropdown-menu-right\" role=\"menu\">";
    $row[2] .= "<li><a href=\"JavaScript:void(0)\" onclick=\"jsonloc('{$aRow[0]}','5')\"><i class=\"fa fa-edit\"></i>Editar</a></li>";
    $row[2] .= "<li><a href=\"JavaScript:void(0)\" onclick=\"jsonloce('{$aRow[0]}','5')\"><i class=\"fa fa-trash\"></i> Eliminar</a></li>";
    $row[2] .= "</ul>";
    $row[2] .= "</div>";
    $output['aaData'][] = $row;
}
