...
while ($aRow = mysqli_fetch_array($rResult)) 
{
   ...
   if($aRow['required']==1)
    ...
    $row[6] = $aRow['valor'];      
        ...
        $row[7] .= "<li><a href=\"JavaScript:void(0)\" onclick=\"getJson('{$aRow[0]}','1')\"><i class=\"fa fa-edit\"></i>Editar</a></li>";
        $row[7] .= "<li><a href=\"JavaScript:void(0)\" onclick=\"jsonid('{$aRow[0]}','1')\"><i class=\"fa fa-trash\"></i> Eliminar</a></li>";
        $row[7] .= "</ul>";
        $row[7] .= "</div>";   
    $output['aaData'][] = $row;
}
