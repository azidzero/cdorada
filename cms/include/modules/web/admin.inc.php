...
switch ($o) 
{
    case 0:
        ...
        <div class="well well-sm">
            <form action="./?m=web&s=admin&o=10" class="form" method="post" enctype="multipart/form-data" >
         ...
         switch($xy)
         {
             case 0:
                 ?>
                   ...
                   <td>
                       <input type="checkbox" name="required" id="required" checked="<?php if($req[0][$i]=='1'){echo "true"; }?>" <?php if($req[0][$i]=='1'){echo "disabled"; }?> >
                   </td>
                  <?php
              break;
              case 1:
