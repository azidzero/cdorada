...
<div class="bg-danger" >
    ...
    <div class="col-lg-12 text-right">
        <button class="btn btn-success" id="savecats" onclick="savecat()"><i class="fa fa-save"></i> Guardar</button>
    </div>
</div>
<?php
$gc = "select * from web_activity_category where lang='$lng'";
                ...
                <tr class="text-success">
                    ...
                    <td>
                        <div class="input-group-btn ">
                            <button class="btn btn-info " onclick="editcat(<?php echo $c['id']; ?>)"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger " onclick="delcat(<?php echo $c['id']; ?>)"><i class="fa fa-remove"></i></button>
                        </div>
                    </td>
                </tr>
                <?php
