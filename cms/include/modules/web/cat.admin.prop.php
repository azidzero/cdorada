...
<div class="bg-danger" >
    ...
    <div class="col-lg-12 text-right">
        <button class="btn btn-success" id="savecats" onclick="savecatprop()"><i class="fa fa-save"></i> Guardar</button>
    </div>
</div>
<?php
$gc = "select * from web_prop_category where lang='$lng'";
                ...
                <tr class="text-success">
                    ...
                    <td>
                        <div class="input-group-btn ">
                            <button class="btn btn-info " onclick="editcatprop(<?php echo $c['id']; ?>)"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger " onclick="delcatprop(<?php echo $c['id']; ?>)"><i class="fa fa-remove"></i></button>
                        </div>
                    </td>
                </tr>
                <?php
