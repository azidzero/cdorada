...
switch ($o) {
    case 0:
        ...
        <form action="./?m=web&s=info&o=1" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group">
                            <select id="post-cat" name="post-cat" class="form-control">
                                <option disabled selected><?php echo $lang->getString("info", "post-cat-default"); ?></option>
                                <?php
                                $oq = mysqli_query($CNN, "SELECT * from web_info_category where pid=0");
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-info " onclick="showCatinfo('es')" type="button"  title="Administrar Categorias" alt="Administrar Categorias"><i class="fa fa-plus-circle "></i></button>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    foreach ($language as $L) {
                        ...
                        ?>">
                            <a href="#tab_<?php echo $L; ?>" aria-controls="tab_<?php echo $L; ?>" role="tab" data-toggle="tab">
                                ...
                                <?php if ($L == "es") { ?>
                                    <span class="label label-danger "><?php echo $lang->getString("info", "post-label-required"); ?></span>
                                    <?php
                                }
                                ?>
                            </a>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><?php echo $lang->getString("info", "post-title"); ?>:</span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="input-group" style="vertical-align:text-top;">
                                            <span class="input-group-addon"><?php echo $lang->getString("info", "post-cover"); ?>:</span>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><?php echo $lang->getString("info", "post-short-desc"); ?>:</span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                ...
                                                <strong><?php echo $lang->getString("info", "post-content"); ?></strong></span>
            ...
            <div class="well well-sm">
                <button class="btn btn-primary" onclick="unifiyContent()"><?php echo $lang->getString("info", "post-btn-save"); ?></button>
            </div>
        </form>
            ...
            <div class="modal-dialog modal-lg" style="width:20%;">
                <div class="modal-content">
                    ...
                    <div class="modal-body" >
                        ...
                        <button type="text" class="btn btn-danger" onclick="dodellcatinfo()">Eliminar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    case 1:
        ...
        mysqli_query($CNN, "INSERT INTO web_info(fecha,hora,cat) VALUES('$date','$time','$categ')") or $e = mysqli_error($CNN);
        if (!isset($e)) {
            echo "<h4>Se ha guardado la actividad.</h4>";
            $id = mysqli_insert_id($CNN);
            $str = md5($id);
            mysqli_query($CNN, "UPDATE web_info SET str='$str' WHERE id='$id'") or die(mysqli_error($CNN));
            // # DATA
            foreach ($language as $L) {
                unset($le);
                mysqli_query($CNN, "INSERT INTO web_info_translate(uid,lang,title,short_desc,content)
                    VALUES('$id','$L','{$data[$L]['post-title']}','{$data[$L]['post-short-desc']}','{$data[$L]['post-content']}')") or $le = mysqli_error($CNN);
                if (!isset($le)) {
                    // # COVER's
                    $path = 'content/info/item_' . str_pad($id, 6, '0', STR_PAD_LEFT) . "-" . $L . '.jpg';
                ...
                <div class="col-lg-12">
                    ...
                    <script>
                        var dz = $("#act_ima").dropzone({
                            maxFilesize: 200,
                            url: "content/upload/info/upload.inc.php?id=<?php echo $id; ?>",
        ...
        <form action="./?m=web&s=info&o=4" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-lg-4">
                    <div class="input-group">
                        ...
                        <div class="input-group">
                            <select id="post-cat" name="post-cat" class="form-control">
                                <?php
                                $getcat = mysqli_query($CNN, "select * from web_info where id=$id")or $err = mysqli_error($CNN);
                                $ct = 0;
            ...
            <div>
                ...
                <div class="tab-content">
                    <?php
                    foreach ($language as $L) {
                        $q = mysqli_query($CNN, "SELECT * from web_info_translate WHERE uid='$id' AND lang='$L'");
                        $n = mysqli_num_rows($q);
                        if ($n > 0) {
                        ...
                        ?>" id="tab_<?php echo $L; ?>">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="hidden" id="post-content-<?php echo $L; ?>" name="post-content-<?php echo $L; ?>" />
                                        <span class="input-group-addon"> <strong><?php echo $lang->getString("info", "post-content"); ?></strong></span>
                ...
                <div class="col-lg-12">
                    ...
                    <script>
                        ...
                        $(document).ready(function ()
                        {
                            $.ajax({
                                method: "POST",
                                url: "include/modules/web/galleryinfo.ajax.php?id=<?php echo $id; ?>",
                                data: {"id": "<?php echo $id; ?>"}
                            }).done(function (data) {
                                $("#gal_activiy").html(data);
                            });
    ...
    case 4:
        ...
        $upd=  mysqli_query($CNN, "update web_info_translate set category=$cat where uid=$id");
        $lq = mysqli_query($CNN, "SELECT * from cms_translation_lang WHERE status=1") or die(mysqli_error($CNN));
        $language = array();
        while ($lr = mysqli_fetch_array($lq)) {
            $language[] = $lr['iso_639_1'];
        ...
        foreach ($language as $L) {
            ...
            $SQL = "UPDATE web_info_translate SET
    ...
    case 5:
        $id = filter_input(INPUT_GET, "id");
        ?>
        <form action="./?m=web&s=info&o=6" method="POST">
            <input type="hidden" id="id" name="id" value="<?php echo $id; ?>" />
            <div class="alert alert-warning">
                ...
                <br/>
                <div class="btn-group">
                    <a href="./?m=web&s=info&o=0" class="btn btn-warning"><i class="fa fa-plus"></i> Agregar Nuevo</a>
                    <a href="./?m=web&s=info&o=2" class="btn btn-warning"><i class="fa fa-chevron-left"></i> Regresar</a>
    ...
    case 6:
        $id = filter_input(INPUT_POST, "id");
        mysqli_query($CNN, "DELETE FROM web_info WHERE id='$id'") or $e = mysqli_error($CNN);
        mysqli_query($CNN, "DELETE FROM web_info_translate WHERE uid='$id'") or $e = mysqli_error($CNN);
        $getima=  mysqli_query($CNN, "select * from web_info_gallery where aid=$id ")or $e=mysqli_error($CNN);
        while($ii=  mysqli_fetch_array($getima))
        {
           unlink("content/upload/info/".$ii['name']."_b.jpg");
           unlink("content/upload/info/".$ii['name']."_m.jpg");
        }
        mysqli_query($CNN, "DELETE FROM web_info_gallery WHERE aid='$id'") or $e = mysqli_error($CNN);
        if (!isset($e)) {
            ?>
