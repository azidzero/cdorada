    ...
    function getFeatured() {
        ...
        <div id="featured-home" class="carousel slide">
            <div class="carousel-inner">
                <?php
                $q = mysqli_query($this->CNN, "SELECT * from web_featured where status='1' order by id DESC") or die(mysqli_error());
                $n = 1;
                while ($r = mysqli_fetch_array($q)) {
                    ...
                    if ($n == 1) {
                        ...
                        echo "<div class=\"item\" style=\"background-image: url('cms/content/featured/$ref');\">";
                    }
                    if ($r["title"] != "") {
