<section id="actividades" class="activity-blog" style="margin-top:110px;">
    <?php
    $limit = 8;
    ...
    $cat = $_REQUEST["o"];
    $cat = str_replace("-", " ", $cat);
    $cq = mysqli_query($CNN, "SELECT * from web_activity_cat WHERE name='$cat'");
    ...
    <div class="container-fluid">
        <h3>ACTIVIDADES - <?php echo $cat; ?></h3>
        <?php
        $olang = $lang;
        $q = mysqli_query($CNN, "SELECT * from web_activity where cat='$catid' order by id DESC LIMIT 8") or die(mysqli_error($CNN));
        while ($r = mysqli_fetch_array($q)) {
            ...
            if (!isset($le)) {
                while ($or = mysqli_fetch_array($oq)) {
                    ...
                    $url = "./$olang/actividades/articulo/$title" . "_" . $r["id"];
                    ?>
                    <div class="post">
